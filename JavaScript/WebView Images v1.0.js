...
document.getElementById('frmSearch').onsubmit = function() { window.location = 'https://www.google.com/webhp?tbm=isch' + document.getElementById('txtSearch').value; return false; 
}