...
document.getElementById('frmSearch').onsubmit = function() { window.location = 'https://www.google.com/webhp?sa=X&output=search&tbm=' + document.getElementById('txtSearch').value; return false; 
}